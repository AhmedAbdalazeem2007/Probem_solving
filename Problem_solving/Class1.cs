...
namespace Problem_solvig
{
    ...
    public class File_1
    {
        ...
        public void existe(string path)
        {
            if (File.Exists(path))
            {
        ...
        public void time_of_creation(string path)
        {
            DateTime dt = File.GetCreationTime(path);
            Console.WriteLine($"Creation time: {dt}");
        }
        public void lasttimewrite(string path)
        {
        ...
        public void fun1()
        {
            ...
            File.WriteAllLines("oop.txt", str);
    ...
    public class Color_1
    {
        ...
        //public Color_1()
        //{
        //    Color color = Color.FromRgb(32, 178, 170);
        //    color = Color.Red;
    ...
    */
    ...
    public class Quran
    {
        ...
        public Quran()
        {
            sum_v_i = Verses.Select((p, i) =>
            {
                return p + i + 1;
            }
            ).ToArray();
            sum_verses = Array_1.sum(Verses);
            count_even = sum_v_i.Where((i) => i % 2 == 0).Count();
            count_odd = sum_v_i.Where((i) => i % 2 != 0).Count();
            sum_even = sum_v_i.Where((i) => i % 2 == 0).Sum();
            sum_odd = sum_v_i.Where((i) => i % 2 != 0).Sum();
            count_digit = Verses.Select((p) => NUmber.count_of_digits(p)).Sum();
            sum_digit = Verses.Sum((i) => NUmber.sum_of_digits(i));
 ...
 */
    ...
    //Predicate<string> predi  cate = pp;
    //Action<int> action = (a) =>
    //{
